...
public class Task2 {
    ...
    public void insertScriptsToTable2Task2() throws SQLException {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(INSERT_SCRIPT_FILE2, false))) {
            ...
            bw.newLine();
            bw.write(INSERT_SCRIPT2 + "'" + 17 + "', '" + "2012.05.03" + "', '" + 1500 + "');");
            bw.newLine();
            bw.write(INSERT_SCRIPT2 + "'" + 7 + "', '" + "2011.05.03" + "', '" + 2500 + "');");
            bw.newLine();
            bw.write(INSERT_SCRIPT2 + "'" + 9 + "', '" + "2013.05.03" + "', '" + 3500 + "');");
            bw.newLine();
            bw.write(INSERT_SCRIPT2 + "'" + 8 + "', '" + "2016.05.03" + "', '" + 4500 + "');");
            bw.newLine();
            bw.write(INSERT_SCRIPT2 + "'" + 6 + "', '" + "2001.05.03" + "', '" + 5600 + "');");
            bw.newLine();
            bw.write(INSERT_SCRIPT2 + "'" + 5 + "', '" + "2008.05.03" + "', '" + 5700 + "');");
            bw.newLine();
            bw.write(INSERT_SCRIPT2 + "'" + 4 + "', '" + "2021.05.03" + "', '" + 5900 + "');");
            bw.newLine();
            bw.write(INSERT_SCRIPT2 + "'" + 2 + "', '" + "2023.05.03" + "', '" + 1500 + "');");
            bw.newLine();
        } catch (IOException e) {
            e.printStackTrace();
        }
